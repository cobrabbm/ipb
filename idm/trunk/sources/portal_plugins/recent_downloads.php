...
class ppi_recent_downloads
{
	...
	* @return VOID
	*/
	function recent_downloads_last_x()
	{
		...
		$files = array();
		$files = $idm_api->return_idm_data( $member['id'], 10, 1 );
		...
		$output = $this->ipsclass->compiled_templates['skin_downloads_external']->portal_block( $this->ipsclass->lang['latest_downloads'], $data );
