...
$SQL[] = "ALTER TABLE ibf_downloads_cfields ADD cf_topic TINYINT( 1 ) NOT NULL DEFAULT '0', ADD cf_search TINYINT( 1 ) NOT NULL DEFAULT '0';";

$SQL[] = "ALTER TABLE ibf_downloads_comments ADD comment_append_edit TINYINT( 1 ) NOT NULL DEFAULT '0',
...
$SQL[] = "ALTER TABLE ibf_downloads_files ADD file_broken_info VARCHAR( 255 ) NULL AFTER file_broken_reason ;";
