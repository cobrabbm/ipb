...
+---------------------------------------------------------------------------
|
|   > PORTAL PLUG IN MODULE: Recent downloads - CONFIG FILE
...
*
*/
$PORTAL_CONFIG['pc_title'] = 'IP.Downloads Manager Recent Downloads';

/**
* Plug in mini description
*
*/
$PORTAL_CONFIG['pc_desc']  = "Shows IP.Downloads Manager recent downloads with names and date uploaded";
...
*/
$PORTAL_CONFIG['pc_exportable_tags']['recent_downloads_last_x']             = array( 'recent_downloads_last_x'            , 'Shows IP.Downloads Manager recent downloads with names and date uploaded' );
