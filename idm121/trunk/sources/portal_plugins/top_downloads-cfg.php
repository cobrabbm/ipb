...
*
*/
$PORTAL_CONFIG['pc_title'] = 'IP.Downloads Manager Top Downloads';

/**
* Plug in mini description
*
*/
$PORTAL_CONFIG['pc_desc']  = "Shows top downloaded files from the IP.Downloads Manager";
...
*/
$PORTAL_CONFIG['pc_exportable_tags']['top_downloads']             = array( 'top_downloads'            , 'Shows top downloaded files from the IP.Downloads Manager' );
