...
+---------------------------------------------------------------------------
|
|   > PORTAL PLUG IN MODULE: Random Downloads
...
class ppi_random_downloads
{
	...
	*/
	function random_downloads()
	{
		...
		$files = array();
		$files = $idm_api->return_idm_data( $member['id'], 10, 1, 'RAND()' );
		...
		$output = $this->ipsclass->compiled_templates['skin_downloads_external']->portal_block( $this->ipsclass->lang['idm_portal_random'], $data );
