...
$SQL[] = "ALTER TABLE ibf_downloads_files ADD file_url TINYTEXT NULL;";
$SQL[] = "ALTER TABLE ibf_downloads_files ADD file_ssurl TINYTEXT NULL;";
$SQL[] = "ALTER TABLE ibf_downloads_files ADD file_realname VARCHAR( 255 ) NULL;";
$SQL[] = "ALTER TABLE ibf_downloads_files ADD file_broken_reason TEXT NULL;";
