...
*/
define( 'INS_ROOT_PATH', str_replace( "//", "/", str_replace( "/core", "", str_replace( "\\", "/", dirname( __FILE__ ) ) ) ) . "/" );
...
* @since 2.0.0.2005-01-01
*/
define( 'ROOT_PATH', preg_replace( "#/{1,}#", "/", str_replace( "/idm_setup/core", "", str_replace( "\\", "/", dirname( __FILE__ ) ) ) ) . "/" );
