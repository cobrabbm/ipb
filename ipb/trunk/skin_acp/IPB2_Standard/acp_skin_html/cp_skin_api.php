...
$IPBHTML .= <<<EOF
<div class='tableborder'>
 <div class='tableheaderalt'>XML-RPC API 账号</div>
 <table cellpadding='0' cellspacing='0' width='100%'>
 <tr>
  <td class='tablesubheader' width='1%'>&nbsp;</td>
  <td class='tablesubheader' width='55%'>API 账号</td>
...
<script type="text/javascript">
  ...
  new Array(
			img_edit   + " <a href='{$this->ipsclass->base_url}&amp;{$this->ipsclass->form_code}&amp;code=api_edit&amp;api_user_id={$user['api_user_id']}'>编辑 API 账号...</a>",
  			img_delete + " <a href='#' onclick='maincheckdelete(\"{$this->ipsclass->base_url}&amp;{$this->ipsclass->form_code}&amp;code=api_remove&amp;api_user_id={$user['api_user_id']}\");'>删除 API 账号...</a>"
  		    ) );
 </script>
EOF;
	}
...
$IPBHTML .= <<<EOF
 <tr>
	<td colspan='5' class='tablerow1' style='text-align:center;font-size:14px'><em>当前没有任何激活的 API 账号.<br /><a href='{$this->ipsclass->base_url}&amp;{$this->ipsclass->form_code}&amp;code=api_add'>您想要创建一个吗?</a></em></td>
 </tr>
EOF;
}
...
<script type="text/javascript">
  menu_build_menu(
  "menumainone",
  new Array( img_add   + " <a href='{$this->ipsclass->base_url}&amp;{$this->ipsclass->form_code}&amp;code=api_add'>创建新的 API 账号...</a>" ) );
</script>
EOF;
...
<div class='tableborder'>
 ...
 <tr>
   <td class='tablerow1'>
      <fieldset>
       <legend><strong>API 账号基本信息</strong></legend>
 		<table cellpadding='0' cellspacing='0' border='0' width='100%'>
EOF;
if ( $type == 'add' )
{
...
$IPBHTML .= <<<EOF
 		<tr>
   		  <td width='40%' class='tablerow1'><strong>API 账号名称</strong><div class='desctext'>这一名称仅仅是作为给身份认证记录的名字.</div></td>
